...
/**
 * This is the item provider adapter for a {@link granja.accion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class accionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GranjaPackage.Literals.ACCION__NOMBRE_ACCION,
				 true,
				 false,
				 false,
	...
	protected void addDescripcionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_accion_descripcion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_accion_descripcion_feature", "_UI_accion_type"),
				 GranjaPackage.Literals.ACCION__DESCRIPCION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GranjaPackage.Literals.ACCION__NUMERO);
		}
	...
	public String getText(Object object) {
		NombreAccion labelValue = ((accion)object).getNombreAccion();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GranjaPackage.Literals.ACCION__NUMERO,
